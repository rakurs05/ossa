...
deps-dlist:
	$(info [CC] Building ./core/dlist/list.c -> ./lib/list.a)
	@$(CC) -c ./core/dlist/list.c $(CFLAGS) -fpic -o ./lib/list.a
core-core.c:
	$(info [CC] Building ./core/core.c -> ./lib/core.o)
	@$(CC) ./core/core.c $(CFLAGS) -fpic -lzip -ldl -o ./lib/core.o ./lib/list.a
core-shared:
